...
public class MainActivity extends Activity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    Book book = new Book("The Helping Phriendly Book", author1, published, chapters, image);
      ...
      final long id = DatabaseHelper.insert(shillelaghApp.getSqlOpenHelper(), book);
      if (id > 0) {
          Toast.makeText(this, "Insert success " + id, Toast.LENGTH_SHORT).show();
      } else {
          Toast.makeText(this, "Insert failure", Toast.LENGTH_SHORT).show();
